#!/usr/bin/env python3
"""embed.py — the irreducible embedding call (Codex cannot produce embedding vectors).
...
Config (user-supplied embedding endpoint, paperbanana-style — text/reasoning is Codex, only
