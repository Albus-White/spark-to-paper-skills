#!/usr/bin/env python3
"""kg_recall.py — retrieve the Top-K candidate research PATTERNS for an idea (for Codex to reason over).

Deterministic retrieval only (vector math + graph hops); the RANKING JUDGEMENT is Codex's job —
