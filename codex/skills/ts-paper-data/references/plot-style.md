...
Use the active venue's typography when it specifies one. Otherwise use the portable default from
`plot_style.py`. Do not impose one font family across unrelated venues.
...
canonical lifecycle result facts. No invented trends.
