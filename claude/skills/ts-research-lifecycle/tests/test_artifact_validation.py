...
class ArtifactValidationTest(unittest.TestCase):
 ...
 def test_physical_study_contract_uses_domain_neutral_fields(self):
  ...
  contract={"claim_ids":["C-001"],"evaluation_units":[{"unit_id":"EU-001","kind":"observational_analysis","claim_ids":["C-001"],"question":"Does treatment change conductivity?","why_it_tests_claim":"matched specimens","protocol_summary":"calibrated impedance protocol","positive_interpretation":"supports","negative_interpretation":"rejects","confounders":["calibration drift"],"out_of_scope_conclusions":["other temperatures"],"difficulty":{"rating":"moderate"},"stop_condition":"precision reached"}],"study_inputs":["specimen batch"],"protocol":{"measurement":"calibrated impedance"},"outcomes":["conductivity"],"comparators":["untreated specimens"],"analysis_plan":{"estimand":"matched difference"},"test_set_policy":{"max_test_access":1},"stop_conditions":["precision reached"],"resource_plan":{"max_runs":4,"max_branches":1,"max_branch_depth":1},"feasibility":{"status":"MEASURED"},"benchmark_policy":{"classification":"NO_VALID_PUBLIC_BENCHMARK"},"venue_alignment":{"rationale":"physical-study conventions"},"revalidation_policy":{"required":False},"idea_iteration_policy":{"negative_result_policy":"retain"}}
